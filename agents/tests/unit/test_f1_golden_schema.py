"""Schema/quality gate for `agents/evals/f1/golden.jsonl` (phase-02 §2,
§8: "25 golden agent turns scored by LLM judge"). Per the revised testing
policy and docs/decisions/0015, this is schema-only: `iam_sentinel_agents.
evals.runner` (phase-12) doesn't exist yet and no deployed Prime/F1 agent
exists to actually run a turn against -- same shape of deferral ADR 0004
applied to the prompt-injection corpus before Prime existed.
"""
...
GOLDEN_PATH = Path(__file__).resolve().parents[2] / "evals" / "f1" / "golden.jsonl"
