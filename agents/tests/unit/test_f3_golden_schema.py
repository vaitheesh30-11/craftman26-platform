"""Schema/quality gate for `agents/evals/f3/golden.jsonl` (phase-04 §8:
"25 golden turns"). Per the revised testing policy and the same deferral
shape as ADR 0015 (F1): `iam_sentinel_agents.evals.runner` (phase-12)
doesn't exist yet and no deployed Prime/F3 agent exists to run a turn
against -- this is schema-only, scaled down from 25 to 7 entries covering
...
GOLDEN_PATH = Path(__file__).resolve().parents[2] / "evals" / "f3" / "golden.jsonl"
