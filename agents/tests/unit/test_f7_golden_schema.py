"""Schema/quality gate for `agents/evals/f7/golden.jsonl` (phase-08 §8: "20
golden turns"). Per the revised testing policy and docs/decisions/0015's
precedent (extended here to F7), this is schema-only: `iam_sentinel_agents.
evals.runner` (phase-12) doesn't exist yet and no deployed CollisionResolver
Bedrock Agent exists to actually run a turn against.
"""
...
GOLDEN_PATH = Path(__file__).resolve().parents[2] / "evals" / "f7" / "golden.jsonl"
