"""Schema/quality gate for `agents/evals/f8/golden.jsonl` (phase-09 §8:
"20 golden turns"). Per the revised testing policy and docs/decisions/0015
(F1's identical deferral), this is schema-only: `iam_sentinel_agents.
evals.runner` (phase-12) doesn't exist yet and no deployed Prime/F8 agent
exists to actually run a turn against.
"""
...
GOLDEN_PATH = Path(__file__).resolve().parents[2] / "evals" / "f8" / "golden.jsonl"
